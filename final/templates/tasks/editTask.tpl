    ...
    <div class='row profile'>
        ...
        <div class='col-md-9'>
            <div class="card card-container">
                <form class="form-horizontal" action="{$BASE_URL}actions/projects/editTask.php?projID={$smartyProjID}&taskID={$smartyTaskID}" method="post">
                    <h2>Edit Task</h2>
                    ...
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-4 control-label" ></label>  
                            <div class="col-md-4">
                                <a href="{$BASE_URL}actions/projects/deleteTask.php?projID={$smartyProjID}&taskID={$smartyTaskID}" id="deleteTask" class="btn btn-danger"><span class="glyphicon glyphicon-thumbs-up"></span> Delete Task</a>
                            </div>
                        </div>
                    </fieldset>
                </form>
