			...
			<nav id="mainNav" class="navbar navbar-default navbar-custom n">
				<div class="container">
					...
					<div class="navbar-header page-scroll">
						...
						<a class="navbar-brand page-scroll" href="https://gnomo.fe.up.pt{$BASE_URL}pages/general/mainPage.php#page-top">YM</a>
					</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-left">
							...
							<li>
								<a class="page-scroll" href="https://gnomo.fe.up.pt{$BASE_URL}pages/general/mainPage.php">Home</a>
							</li>
							<li>
